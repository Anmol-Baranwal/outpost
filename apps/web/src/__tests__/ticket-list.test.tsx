...
const testTickets: Ticket[] = [
    {
        ...
        description:
            'When using CopilotRuntime with a custom action that returns a large payload, the streaming response crashes.',
    ...
    },
    {
        ...
        description:
            'The useCopilotChat hook does not trigger re-renders when new messages arrive.',
