 ...
 */
import { MessageStatus, UrgencyLevel, } from './types.js';
 ...
 */
export function getUrgencyLevel(message, now = new Date()) {
 ...
 */
export function getUnansweredDurationMs(message, now = new Date()) {
 ...
 */
export function checkUnansweredMessages(messages, now = new Date()) {
 ...
 */
export function formatMessageDuration(ms) {
